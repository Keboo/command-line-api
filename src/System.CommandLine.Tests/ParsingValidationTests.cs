...
public class ParsingValidationTests
{
    ...
    public void A_custom_validator_added_to_a_global_option_is_checked(string commandLine)
    {
        ...
        result.Errors.Single().Message.Should().Be("oops!");
    }
    ...
    private static CliArgument<string> CreateArgumentWithAcceptOnlyFromAmong(string name, params string[] values)
    {
