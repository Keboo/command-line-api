...
public partial class ParserTests
{
    ...
    {
        CliCommand expectedCommand = new("three");
        ...
        result.CommandResult.Command.Should().BeSameAs(expectedCommand);
    }
    ...
    {
        CliArgument<string> arg1 = new("arg1");
        CliArgument<string> arg3 = new("arg3");
        CliArgument<string> arg4 = new("arg4");
        CliCommand nonUniqueCommand = new("non-unique")
        {
            arg4
        };
        var command = new CliCommand("outer")
        ...
        result.GetValue(arg1).Should().Be("arg1");
        result.GetValue(arg3).Should().Be("arg2");
        result.GetValue(arg4).Should().Be("arg3");
        result.CommandResult.Command.Should().BeSameAs(nonUniqueCommand);
    }
